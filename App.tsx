  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans selection:bg-[#d4af37] selection:text-black">
      ...
      <main className="max-w-[1600px] mx-auto p-4 md:p-10">
        ...
        {activeView === 'home' && (
          <MainDashboard protocols={savedProtocols} onNew={handleNew} onList={() => setActiveView('search')} onLoadStudent={(p, v) => loadStudent(p, v as ViewMode)} />
        )}

        {activeView === 'search' && (
          <StudentSearch protocols={savedProtocols} onLoad={(p, v) => loadStudent(p, v as ViewMode)} onDelete={deleteStudent} />
        )}
