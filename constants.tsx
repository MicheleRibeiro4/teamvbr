...
2.2. Ao final do período, o contrato não será renovado automaticamente, podendo sê-lo mediante nova contratação e novo pagamento.
...
a) Estar ciente de que o contratado NÃO É PROFISSIONAL DE EDUCAÇÃO FÍSICA, NUTRIÇÃO OU MEDICINA, e que os conteúdos fornecidos não substituem acompanhamento profissional habilitado;
b) Ser o único responsável pela execução das atividades sugeridas, bem como pela busca de orientação profissional (personal trainer, nutricionista, médico) sempre que necessário;
...
7.1. O contratante poderá desistir da contratação no prazo de até 7 (sete) dias corridos da data de assinatura do contrato ou pagamento, conforme art. 49 do Código de Defesa do Consumidor.
7.2. Em caso de desistência dentro do prazo legal:
a) Caso ainda não tenha ocorrido a disponibilização do material e início da prestação dos serviços, o valor pago será integralmente restituído;
b) Considerando que o material e os serviços são disponibilizados de forma integral e não fracionada, não se aplica a hipótese de entrega parcial.
7.3. Após o prazo de 7 (sete) dias, o cancelamento poderá ser solicitado a qualquer tempo, com restituição proporcional ao período não usufruído.
7.4. Não haverá restituição nas hipóteses de:
a) Desistência voluntária após a entrega completa dos materiais contratados;
b) Inadimplência do contratante;
c) Rescisão por justa causa motivada por descumprimento das obrigações pelo contratante.

CLÁUSULA 8 – TRATAMENTO DE DADOS PESSOAIS (LGPD)
8.1. Os dados pessoais fornecidos pelo contratante serão utilizados exclusivamente para:
a) Execução do objeto contratual;
b) Comunicação entre as partes;
c) Cumprimento de obrigações legais e regulatórias.
8.2. O contratado não compartilhará os dados com terceiros, salvo:
a) Determinação judicial ou requisição de autoridade competente;
b) Consentimento expresso e por escrito do contratante.
8.3. O contratante poderá, a qualquer tempo, solicitar:
a) A correção de dados incompletos, inexatos ou desatualizados;
b) A exclusão dos dados, ressalvada a hipótese de guarda obrigatória por prazo legal;
c) A exportação dos dados fornecidos.

CLÁUSULA 9 – PROPRIEDADE INTELECTUAL
9.1. Os materiais informativos, e-books, planilhas genéricas, vídeos e demais conteúdos fornecidos pelo contratado são protegidos por direitos autorais, sendo permitido ao contratante o uso exclusivamente pessoal e intransferível.
9.2. É expressamente vedada a reprodução, distribuição, comercialização, compartilhamento em redes sociais, grupos ou qualquer outra forma de disponibilização a terceiros sem autorização expressa e por escrito do contratado.

CLÁUSULA 10 – AUTORIZAÇÃO DE USO DE IMAGEM
10.1. O CONTRATANTE autoriza o uso de sua imagem, nome, voz, fotos, vídeos, depoimentos e resultados físicos (inclusive “antes e depois”) para fins de divulgação e marketing dos serviços do CONTRATADO.
10.2. A autorização é gratuita e poderá ser utilizada em redes sociais, website e materiais publicitários.
10.3. O CONTRATANTE declara ciência de que os resultados são individuais e não garantem padrão a terceiros.
10.4. A autorização poderá ser revogada por escrito, não atingindo publicações já realizadas.

CLÁUSULA 11 – DISPOSIÇÕES GERAIS
11.1. Este contrato regula integralmente a relação entre as partes, prevalecendo sobre quaisquer entendimentos, acordos ou negociações anteriores.
11.2. A tolerância quanto ao descumprimento de qualquer cláusula não constituirá novação, precedente ou renúncia a direitos.
11.3. O contratado NÃO REALIZA PRESCRIÇÃO MÉDICA, NUTRICIONAL OU FARMACOLÓGICA. Qualquer uso de medicamentos, hormônios ou suplementos deverá ser acompanhado por profissional habilitado (médico ou nutricionista), sob integral responsabilidade do contratante.
11.4. A comunicação oficial entre as partes dar-se-á preferencialmente por escrito, por meio dos endereços eletrônicos indicados na qualificação.

CLÁUSULA 12 – FORO
12.1. Fica eleito o foro da comarca do domicílio do CONTRATADO para dirimir quaisquer controvérsias oriundas deste contrato, com renúncia expressa a qualquer outro, por mais privilegiado que seja.`;
