...
3.2. Forma de pagamento: [PAYMENT_METHOD] ([INSTALLMENTS]x).
...
10.1. Este contrato regula integralmente a relação entre as partes, prevalecendo sobre quaisquer entendimentos, acordos ou negociações anteriores.
10.2. A tolerância quanto ao descumprimento de qualquer cláusula não constituirá novação, precedente ou renúncia a direitos.
10.3. O contratado NÃO REALIZA PRESCRIÇÃO MÉDICA, NUTRICIONAL OU FARMACOLÓGICA. Qualquer uso de medicamentos, hormônios ou suplementos deverá ser acompanhado por profissional habilitado (médico ou nutricionista), sob integral responsabilidade do contratante.
10.4. A comunicação oficial entre as partes dar-se-á preferencialmente por escrito, por meio dos endereços eletrônicos indicados na qualificação.

CLÁUSULA 11 – FORO
11.1. Fica eleito o foro da comarca do domicílio do CONTRATADO para dirimir quaisquer controvérsias oriundas deste contrato, com renúncia expressa a qualquer outro, por mais privilegiado que seja.`;
...
export const INITIAL_DATA: ProtocolData = {
  ...EMPTY_DATA,
  id: "initial-demo",
  clientName: "Eronilson de Souza Silva",
  ...
  physicalData: {
    ...
    visceralFat: "7",
    imc: "26",
    observations: "Aluno com boa resposta a estímulos de força, mas necessita controle de BF."
  },
  ...
  supplements: [
    { id: 's1', name: "Creatina", dosage: "5g", timing: "Qualquer horário" },
    { id: 's2', name: "Whey Protein", dosage: "30g", timing: "Pós-treino" }
  ],
  ...
  generalObservations: "Foque na constância e no descanso adequado. O resultado é a soma do que fazemos todos os dias.",
  contract: {
    ...EMPTY_DATA.contract,
    cpf: "333.572.198-59",
    email: "eron-souza@hotmail.com",
    phone: "(11) 99275-2398",
    address: "Av. Brigadeiro Luiz Antonio, 1404, Apto 418",
    startDate: "11/02/2026",
    endDate: "11/05/2026",
    planValue: "289,00",
    planValueWords: "Duzentos e oitenta e nove reais",
    paymentMethod: "Pix",
    installments: "1",
    contractBody: DEFAULT_CONTRACT_TEMPLATE
  }
