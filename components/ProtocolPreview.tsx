...
import { ChevronLeft, Download, Loader2, AlertTriangle, FileText, Maximize2, X, FileDown, Dumbbell } from 'lucide-react';
...
const ProtocolPreview = forwardRef<ProtocolPreviewHandle, Props>(({ data, onBack, hideFloatingButton }, ref) => {
  ...
  return (
    <div className="w-full animate-in fade-in duration-500">
        ...
        {/* CARD DE AÇÃO (Estilo EvolutionTracker) */}
        <div className="bg-[#111] rounded-[2.5rem] p-8 border border-white/10 shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center py-12">
                ...
                <h2 className="text-3xl font-black text-white uppercase tracking-tighter mb-2">Protocolo Completo</h2>
                <p className="text-white/40 text-sm max-w-md mx-auto mb-8">
                    O protocolo de treino e dieta está pronto para ser visualizado e exportado.
                </p>
                <button 
                ...
                >
                    <Maximize2 size={16} /> Visualizar Protocolo
                </button>
            </div>
        </div>
